...
def delete_b_bigger_than_max(**kwargs):
    mysqlserver = MySqlHook('mysql_conn')
    maxVal= kwargs['ti'].xcom_pull(key=None,task_ids='getMaxValue')
...
drop_table_a >> drop_table_b >> create_table_a >> create_table_b >> insert_values_a_1 >> insert_values_a_2 >> insert_values_a_3 >> getMaxValue >> insert_values_a_4 >> deleteBBiggerThanMax >> insertBFromAWhereBiggerThanMax
